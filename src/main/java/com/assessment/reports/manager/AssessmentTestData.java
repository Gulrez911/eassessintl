...
public class AssessmentTestData {
	...
	public AssessmentTestData(Float percentageMarksRecieved, String testName, String user, Integer noOfAttempts, Boolean pass, String sectionResults,String companyId, Date testInviteSent, Boolean sharedDirect, String noOfQuestionsNotAnswered, Date testStartDate, Date testEndDate, Float weightedScorePercentage, Integer noOfNonCompliances) {
		this.percentageMarksRecieved = percentageMarksRecieved;
		this.testName = testName;
		this.user = user;
		this.noOfAttempts = noOfAttempts;
