...
//		return list;
	...
	@Override
	public List<QuestionMapperInstance> findSubjectQuestionMapperInstancesForUserAndTest(String testName, String user,
			String companyId) {
		// TODO Auto-generated method stub
		return questionMapperInstanceRepository.findSubjectQuestionMapperInstancesForUserAndTest(testName, user, companyId);
	}
