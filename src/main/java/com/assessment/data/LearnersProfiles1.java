...
@Entity
public class LearnersProfiles1 extends Base{
	...
	public String toString() {
		return "LearnersProfiles1 [userEmail=" + userEmail + ", qualifier1=" + qualifier1 + ", qualifier2=" + qualifier2 + ", qualifier3=" + qualifier3 + ", qualifier4=" + qualifier4
				+ ", qualifier5=" + qualifier5 + ", qparamValue=" + qparamValue + ", percent=" + percent + "]";
	}
