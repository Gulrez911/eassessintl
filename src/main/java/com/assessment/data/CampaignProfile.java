...
@Entity
public class CampaignProfile extends Base{
	String userEmail;
	String qualifier1;
	String qualifier2;
	String qualifier3;
	...
	public String toString() {
		return "CampaignProfiles [userEmail=" + userEmail + ", qualifier1=" + qualifier1 + ", qualifier2=" + qualifier2 + ", qualifier3=" + qualifier3 + ", qualifier4=" + qualifier4
				+ ", qualifier5=" + qualifier5 + ", qparamValue=" + qparamValue + ", percent=" + percent + ", campaignName=" + campaignName + "]";
	}
}
