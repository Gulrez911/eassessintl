...
Boolean testComplete;
	...
	List<CodingAnswerDTO> codingAnswers = new ArrayList<>();
	...
	public List<CodingAnswerDTO> getCodingAnswers() {
		return codingAnswers;
	}

	public void setCodingAnswers(List<CodingAnswerDTO> codingAnswers) {
