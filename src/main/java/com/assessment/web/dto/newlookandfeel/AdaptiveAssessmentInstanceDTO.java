...
public class AdaptiveAssessmentInstanceDTO {
	AdaptiveAssessmentQuestionMappperInstance questionMapperInstance;
	...
	public AdaptiveAssessmentQuestionMappperInstance getQuestionMapperInstance() {
		return questionMapperInstance;
	}

	public void setQuestionMapperInstance(AdaptiveAssessmentQuestionMappperInstance questionMapperInstance) {
	...
	public String getStyle() {
		if(getQuestionMapperInstance() == null){
			return "notanswered";
		}
	...
	public String getRadioAnswer() {
			...
			else if(getTwo()!= null && getTwo()){
				return "choice2";
			}
			else if(getThree()!= null && getThree()){
				return "choice3";
			}
			else if(getFour()!= null && getFour()){
				return "choice4";
			}
			else if(getFive()!= null && getFive()){
				return "choice5";
			}
			else if(getSix()!= null && getSix()){
				return "choice6";
			}
		return radioAnswer;
	}
	...
	public void setRadioAnswer(String radioAnswer) {
		this.radioAnswer = radioAnswer;
			if(radioAnswer != null){
				if(radioAnswer.equals("choice1")){
					setOne(true);
				}
				else if(radioAnswer.equals("choice2")){
					setTwo(true);
				}
				else if(radioAnswer.equals("choice3")){
					setThree(true);
				}
				else if(radioAnswer.equals("choice4")){
					setFour(true);
				}
				else if(radioAnswer.equals("choice5")){
					setFive(true);
				}
				else if(radioAnswer.equals("choice6")){
					setSix(true);
				}
			}
	}
	...
	public Integer getMtfSize() {
		...
		if(getQuestionMapperInstance().getQuestion().getMatchLeft3() == null || getQuestionMapperInstance().getQuestion().getMatchLeft3().trim().length() == 0){
			return 2;
		}
		
		if(getQuestionMapperInstance().getQuestion().getMatchLeft4() == null || getQuestionMapperInstance().getQuestion().getMatchLeft4().trim().length() == 0){
			return 3;
		}
		
		if(getQuestionMapperInstance().getQuestion().getMatchLeft5() == null || getQuestionMapperInstance().getQuestion().getMatchLeft5().trim().length() == 0){
			return 4;
		}
		
		if(getQuestionMapperInstance().getQuestion().getMatchLeft6() == null || getQuestionMapperInstance().getQuestion().getMatchLeft6().trim().length() == 0){
			return 5;
		}
		return 6;
	}
