...
<html>
		   ...
		   <jsp:include page="side.jsp" /> 
				...
				<div class="pagination">
						...
						<a href="${callingMethod}?page=${nextPage}${queryParam}"><i class="fa fa-arrow-right"></i></a>
                            ...
                            <div class="questiontable">
                                <div class="questionheading">
                                    <div class="left">
                                        <h3>Multi File Local Assessments Problem Records</h3>
                                    </div>
                                    <div class="right">
					...
					<tbody>
										...
										<td>  <input type="text" id="gitrepo${instance.id}" name="gitrepo" class="form-control" value="${instance.gitRepositoryUI}"> </td>
										
										<td>  <input type="text" id="giturl" name="giturl" class="form-control" value="${instance.githubUrlOfUser}"> </td>
										
						                <td> <a href="#" onClick = "javascript:trySubmit('${instance.id}')">Try Submiting Workspace after editing the Git Repo</a>  </td>
	...
	function confirmSubmit(qMapperInstanceId){
		(new PNotify({
		    title: 'Confirmation Needed',
		    text: 'Are you sure you want to submit the user workspace?',
	...
	function submitFullStackCode(instanceid){
		var girrepo = document.getElementById("gitrepo"+instanceid).value;
		var url = 'submitLocalFullStackCode?qMapperInstanceId='+qMapperInstanceId+'&gitRepository='+girrepo;
