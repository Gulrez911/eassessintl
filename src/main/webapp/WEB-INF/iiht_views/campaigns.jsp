           ...
           <section class="content-section">
                <div class="container-fluid">
                    <div class="page-header mb-4">
                        <h1 class="my-auto">Campaigns</h1>
                        <div class="quick-actions my-auto">
<!--                             <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"> -->
                               <button type="button" class="btn btn-primary" onclick="javascript:addCampaign();">
                                Add New Campaign
                            </button>
                        </div>
                    </div>
                               ...
                               <c:forEach  items="${campaigns}" var="campaign" >   
            			            <div class="col-xs-12 col-md-4 col-xl-3 mb-3">
			                            <div class="card">
			                                <div class="card-header">
			                                    ...
			                                    <div class="actions">
			                                        ...
			                                        <div class="options" style="cursor: pointer;display:block">
			                                            <a  class="text-warning" onclick="updateCampaign('${campaign.id}')" >
			                                ...
			                                <div class="card-body">
			                                    <h5 class="card-title">Campaign Name:<span class="text-primary"> ${campaign.campaignName}  </span></h5>
		...
		<script>
			...
			function updateCampaign(id){
				window.location = 'campaign?id='+id;
			}
