 ...
 <div class="master-container">
                ...
                <div class="container-fluid">
                    ...
                    <nav class="">
                       ...
                       <a href="#" class="view-more active">
                            Campaign Reviewers <i class="fa fa-angle-down"></i>
                        </a>
                        <div class="more-nav">
                            <div class="more-nav">
                            <a href="newSkills">
            ...
            <section class="content-section">
                <div class="container-fluid">
                    <div class="page-header mb-4">
                        <h1 class="my-auto">Campaign Reviewers</h1>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 mb-3">
                                ...
                                <div class="input-group mb-0">
                                    <input type="text" class="form-control" placeholder="Search Reviewer" name="searchText" id="searchText" value="${param.searchText}">
                        ...
                        <div class="col-12">
                        		...
                        		<c:forEach  items="${reviewers}" var="rev" varStatus="loop">   
			                        <div class="col-xs-12 col-md-4 col-xl-3 mb-3">
			                            <div class="card">
			                                <div class="card-header">
			                                    <div class="actions">
			                                        ...
			                                        <div class="options" style="cursor: pointer;">
			                                            <a onclick="editReviewer(${rev.id})" class="text-warning">
			                                                <i class="fa fa-edit mr-2"></i> Edit
			                                            </a>
			                                            <a href="javascript:deleteReviewer('${rev.id}')" class="text-danger">
			                                ...
			                                <div class="card-body">
			                                    <h5 class="card-title">${rev.firstName}  </h5>
			                                    <p class="card-text">${rev.lastName}</p>
			                                    <p class="card-text"><span class="text-primary">${rev.email}</span></p>
			                                    <p class="card-text"><span class="text-success">${rev.mobile}</span></p>
			                                </div>
			                            </div>
			                        </div>
			                        </c:forEach>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Create/Edit Reviewer</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                              <form name="tenantForm"  method="post" modelAttribute="cluster" action="saveCampaignReviewer">
				                        <div class="modal-body">
				                                <div class="row">
				                                    <div class="col-12">
				                                        <div class="form-group">
				                                            <label for="">First Name</label>
				                                              <form:input path="reviewer.firstName" name="firstName" id="firstName" required="true" class="form-control"/>
				<!--                                             <input type="text" class="form-control"> -->
				                                    ...
				                                    <div class="col-12">
				                                        <div class="form-group">
				                                           ...
				                                           <form:input path="reviewer.lastName" name="lastName" id="lastName" required="true" class="form-control"/>
																	
																	<form:hidden path="reviewer.id" id="reviewerId"/>
				<!--                                             <input type="text" class="form-control"> -->
				                                        </div>
				                                    </div>
				                                    <div class="col-12">
				                                        <div class="form-group">
				                                            <label for="">Email</label>
				                                             <form:input path="reviewer.email" name="email" id="email" required="true" class="form-control"/>
				                                        </div>
				                                    </div>
				                                    <div class="col-12">
				                                        <div class="form-group">
				                                            <label for="">Mobile</label>
				                                             <form:input path="reviewer.mobile" name="mobile" id="mobile" required="true" class="form-control"/>
				                                        </div>
				                                    </div>
				                                </div>
				                        </div>
        ...
        <script>
    		...
    		function deleteReviewer(id){
			 	 Swal.fire({
				  title: 'Are you sure?',
				  text: "Do you want to delete this Reviewer ?",
				  icon: 'warning',
				  ...
				  if (result.value) {
					 window.location = "newDeleteCluster?reviewerId=" + id;
				  }
				})
	}
    		...
    		function addReviewer(){
    				...
    				$("#exampleModalLongTitle").text("Add Reviewer")
    				$("#exampleModalCenter").modal("show");
        		}
    		
    		function editReviewer(id){
            	$.get("editReviewer?reviewerId=" + id, function(data,	status) {
					
					$("#firstName").val(data.reviewer.firstName);
    				$("#lastName").val(data.reviewer.lastName);
    				$("#email").val(data.reviewer.email);
    				$("#mobile").val(data.reviewer.mobile);
					
    				
    				$("#exampleModalLongTitle").text("Edit Reviewer")
    				$("#exampleModalCenter").modal("show");
             	});
        		}
    	      ...
    	      $('#search').on('click',function(){
          		...
          		if(text.length != 0){
          		window.location="reviewers?searchText="+text;
          		}
          	    });
