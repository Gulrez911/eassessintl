...
<!--                                             <input type="text" class="form-control"> -->
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group">
                                           You, ${fullName}, will be booked at time ${bookingSlot} after completing your payment.
...
<!--                                             <input type="text" class="form-control"> -->
									...
									<table class="table table-bordered" style="margin-right: 30px;">
										<thead >
										  <tr>
											<th background-color="#326fad">Assessment Cost</th>
											<th background-color="#326fad">GST</th>
											<th background-color="#326fad">Payment Gateway</th>
											<th background-color="#326fad">Total Cost</th>
										...
										<tbody>
										  ...
										  <tr>
											<td> ${costForAssessment}</td>
											<td>${gstCharges}</td>
											<td>${gatewayCharge}</td>
											<td>${gatewayCharge + costForAssessment + gstCharges}</td>
										  </tr>
                        ...
                        <div class="modal-footer">
                           <form name="payForm" id="payForm"  method="post"  action="redirectToPaymentGateway">
				<input type="hidden" name="amount" id="amount" value="${amount}" />
				<input type="hidden" name="slotid" id="slotid" value="${slotid}" />
				<input type="hidden" name="userid" id="userid" value="${userid}" />

                            <button type="submit" class="btn btn-primary" style="background-color:#3e7dbd;">Initiate Payment</button>
			</form
                        </div>
