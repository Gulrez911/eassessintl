...
<div class="container" style="width: 70%;font-family: 'DejaVu Sans', Arial, Helvetica, sans-serif;border-bottom: 3px solid blue;border-top: 3px solid blue; padding-top: 11px;padding-bottom: 11px;">
	<form:form method="post" modelAttribute="reviewerComment" action="saveReviewerComment2" name="reviewerComment">
		<form:hidden path="id" />
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="technicalCompetencyInCoreAreas">Core Technical Competency</label>
     <form:input path="technicalCompetencyInCoreAreas" class="form-control" />
    </div>
    <div class="form-group col-md-6">
      <label for="technicalCompetencyInAncillaryAreas">Technical Competency in Ancillary Areas</label>
     <form:input path="technicalCompetencyInAncillaryAreas" class="form-control" />
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
   ...
   <div class="form-row">
    <div class="form-group col-md-6">
      <label for="overallReviewStatus">OverAll Review of the Candidate</label>
    <form:input path="overallReviewStatus" class="form-control" />
    </div>

  <div class="form-group col-md-6">
      <label for="inputEmail4">Current Reviewer</label>
    <form:input path="actualReviewerEmail" class="form-control" disabled="true" />
    </div>
  ...
  <div class="form-group">
    <div class="form-check">
      <form:checkbox path="status" class="form-check-input"  id="gridCheck"/>
      <label class="form-check-label" for="gridCheck">
        Shortlist Candidate
      </label>
    </div>
  </div>
  <button type="submit" class="btn btn-primary" style="margin-left:40%">Save your Feedback </button>
</form:form>
	</div>
...
$(function() {
   ...
   $('button[type=submit]').click(function(e) {
      ...
      $.post({
         ...
         data : $('form[name=reviewerComment]').serialize(),
         success : function(res) {
        	 sweetAlert("Your feedback has been saved. Kindly close th window.",res.msg,"success")
