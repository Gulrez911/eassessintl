		...
		<form:form method="post" modelAttribute="reviewerComment"
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<form:input path="analyticalSkills" class="form-control" disabled="true"/>
				</div>
				<div class="form-group col-md-6">
					<label for="communicationSkills">Communiction Skills</label>
					<form:input path="communicationSkills" class="form-control" disabled="true"/>
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="overallReviewStatus">OverAll Review of the
						Candidate</label>
					<form:input path="overallReviewStatus" class="form-control" disabled="true"/>
				</div>
