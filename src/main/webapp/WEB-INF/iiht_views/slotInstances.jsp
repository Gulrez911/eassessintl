...
<body>
 <div class="master-container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 mb-3">
								...
								<a class="btn btn-large btn-success" onclick='fetchAllSlots()'>Go Back</a>
								</div>
						...
						<thead>
						  <tr>
							...
							<th>Send Email With Link</th>
							<th>View Assessment Results</th>
						  </tr>
						</thead>
						<tbody>
						 <c:forEach  items="${instances}" var="profile" >  
						  <tr>
							<td>${profile.firstName}</td>
							<td>${profile.lastName}</td>
							<td>${profile.email}</td>
							<td>${profile.slot.dateStr}</td>
							<td>${profile.testName}</td>
							<td>	<a href='javascript:sendEmailToBookedClient("${profile.id}")'  > Click</a> </td>
							<td>	<a href='javascript:noimpl("${profile.id}")'  > Click</a> </td>
						  </tr>
						 </c:forEach> 
						</tbody>
					  </table>
		...
		function sendEmailToBookedClient(bid){
			$.ajax({
				url : 'sendEmailToBookedClient?instanceId='+bid,
