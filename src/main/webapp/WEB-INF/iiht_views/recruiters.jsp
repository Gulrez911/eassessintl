                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <form:form name="userForm"  method="post" modelAttribute="usr" action="saveRecruiter">
			                        <div class="modal-body">
			                                <div class="row">
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">First Name</label>
			                                            <form:input path="firstName" name="firstName" id="firstName" required="true" class="form-control" />
			                                    ...
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Last Name</label>
                                        							<form:input path="lastName" name="lastName" id="lastName" required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                     <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Company Name</label>
                                         							 <form:input path="recruitmentCompanyName" name="recruitmentCompanyName" id="recruitmentCompanyName" required="true" class="form-control" />	
			                                        </div>
			                                    </div>
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Email</label>
                                         							 <form:input path="email" name="email" id="email" required="true" class="form-control" />	
			                                    ...
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Phone</label>
                                       							  <form:input path="mobileNumber" name="mobileNumber" id="mobileNumber"  required="true" class="form-control" />
<!-- 			                                            <input type="text" class="form-control"> -->
			                                        </div>
			                                    </div>
			                                    <div class="col-xs-12 col-md-6">
			                                        <div class="form-group">
			                                            <label for="">Password</label>
                                    							  <form:password path="password" name="password" id="password"  required="true" class="form-control" />
<!-- 			                                            <input type="password" class="form-control"> -->
        ...
        <script>
        	...
        	function editUser(email){
        		   $.get("editRecruiter?email=" + email, function(data, status) {
