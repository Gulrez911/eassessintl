                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <form:select path="question.stack" class="form-control">
                                    ...
                                    <div class="col-xs-12 col-md-6 mb-2">
                                        <div class="form-group">
                                            <label>GitHut Base URL</label>
                                            <form:input path="question.fullStackGitHupCodeUrl" name="fullStackGitHupCodeUrl" id="fullStackGitHupCodeUrl" class="form-control"/>
<!--                                             <input type="text" class="form-control"> -->
                                    ...
                                    <div class="col-xs-12 col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <form:input path="question.reviewerEmail" name="reviewerEmail" id="reviewerEmail" class="form-control"/>
<!--                                             <input type="email" class="form-control"> -->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6 mb-2">
                                        <div class="form-group">
                                            <label>Upload Test Cases (.xml)</label>
                                            <input type="file" name="addtestcases" id="addtestcases" class="form-control">
<!--                                             <input type="file" class="form-control"> -->
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="">Is the Test MML based?</label>
                                            
											
											<form:checkbox path="question.mmlFullStack" id="mmlFullStack" class="form-control" />
									...
									<div class="col-12">
                                        <div class="form-group">
                                            <label for="">MML URL</label>
                                            
											
											<form:input path="question.mmlStackUrl" name="mmlStackUrl" id="mmlStackUrl"  class="form-control" />
