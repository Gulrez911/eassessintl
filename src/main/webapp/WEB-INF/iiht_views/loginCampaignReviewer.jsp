...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/5.4.0/bootbox.js"></script>
    ...
    <body>
		...
		<div class="logo">
                    ...
                    <div class="navmenu">
			<nav>
                        <button class="btn btn-primary" type="button" onClick="javascript:notify('Registration for Reviewer - Coming Soon!');">
                            sign up
                        </button>
			</nav>
                    </div>
            ...
            <section>
                <div class="container">
                    <div class="mx-auto login-form">
                         <form id="loginForm" method="post" modelAttribute="user" action="campaignreviewerauthenticate">
                            <h2>
                                Login to <span>Eassess</span>
                            </h2>
                            <div>
                            ...
                            <div class="social-login">
                                ...
                                <ul>
                                    <li>
                                        <a href="javascript:notify('Reviewer User Login - Coming Soon!');" class="social linkedin">

                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:notify('Reviewer User Login - Coming Soon!');" class="social google">

                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:notify('Reviewer User Login - Coming Soon!');" class="social facebook">

                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:notify('Reviewer User Login - Coming Soon!');" class="social github">

                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:notify('Reviewer User Login - Coming Soon!');" class="social twitter">
