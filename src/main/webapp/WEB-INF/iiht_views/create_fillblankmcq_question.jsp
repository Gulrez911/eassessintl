                        ...
                        <div class="contents">
                            <div class="main-forms">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            <label for="">No of Fill in Blanks in a Question</label>
                                            <form:input path="question.noOfFillBlanks" name="noOfFillBlanks" id="noOfFillBlanks"  class="form-control"/>
<!--                                             <input type="text" class="form-control"> -->
                                        </div>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            <label for="">Enter comma separated blank answers</label>
                                            	<form:textarea path="question.fillInBlankOptions" name="fillInBlankOptions" id="fillInBlankOptions" class="form-control"/>
...
<!--                                     <input type="text" class="form-control"> -->
                                ...
                                <div class="form-group mt-3">
                                    <label for="constraint">Constraints</label>
                                        <form:textarea path="question.constrnt"  class="form-control" id="constraint" rows="3"  style="height:129px"/>
                                </div>
                                <div class="form-group mt-3">
