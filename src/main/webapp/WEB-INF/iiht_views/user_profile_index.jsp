...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="userprofile/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="userprofile/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="userprofile/css/bootstrap.css">

	<!-- Magnific Popup -->
	<link rel="stylesheet" href="userprofile/css/magnific-popup.css">

	<!-- Flexslider  -->
	<link rel="stylesheet" href="userprofile/css/flexslider.css">

	<!-- Owl Carousel -->
	<link rel="stylesheet" href="userprofile/css/owl.carousel.min.css">
	<link rel="stylesheet" href="userprofile/css/owl.theme.default.min.css">
	
	<!-- Flaticons  -->
	<link rel="stylesheet" href="userprofile/fonts/flaticon/font/flaticon.css">

	<!-- Theme style  -->
	<link rel="stylesheet" href="userprofile/css/style.css">

	<!-- Modernizr JS -->
	<script src="userprofile/js/modernizr-2.6.2.min.js"></script>
	
	
	<link href="css/pnotify.custom.min.css" rel="stylesheet" type="text/css">
	<!-- jQuery -->
	<script src="userprofile/js/jquery.min.js"></script>
	<script type="text/javascript" src="scripts/pnotify.custom.min.js"></script>
	
	<!-- jQuery Easing -->
	<script src="userprofile/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="userprofile/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="userprofile/js/jquery.waypoints.min.js"></script>
	<!-- Stellar Parallax -->
	<script src="userprofile/js/jquery.stellar.min.js"></script>
	<!-- Flexslider -->
	<script src="userprofile/js/jquery.flexslider-min.js"></script>
	<!-- Owl carousel -->
	<script src="userprofile/js/owl.carousel.min.js"></script>
	<!-- Magnific Popup -->
	<script src="userprofile/js/jquery.magnific-popup.min.js"></script>
	<script src="userprofile/js/magnific-popup-options.js"></script>
	<!-- Counters -->
	<script src="userprofile/js/jquery.countTo.js"></script>
	<!-- Main -->
	<script src="userprofile/js/main.js"></script>
					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li><a href="about.html">Manage Modules</a></li>
								
								<li><a href="contact.html">Question Bank</a></li>
								
								<li><a href="contact.html">Test Creation</a></li>
				...
				<div class="row">
					...
					<div class="col-md-3 text-center animate-box">
						<div class="services">
							...
							<div class="desc">
								<h3><a href="javascript:showModulesForLicense('${lic.licenseName}')">${lic.licenseName}</a></h3>
								<p>${lic.licenseDesc}</p>
							</div>
						</div>
					</div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="classModalLabel">
              Share Module With Learners
            </h4>
      </div>
      <div class="modal-body">
		<div class="input-group">
		<span class="input-group-addon" >
			<a href="javascript:showFileDialog();" id="uploadUsers" style="width: 200px;">Click to Import Learners</a>
		</span>
		...
		<a href="javascript:loadUsersForClassifier();" id="uploadUsers">Click to Get Users</a></span>
<form:select path="adminDto.classifierfull" style="class:form-control;margin-left: 30px;" id="classifierfull" >
	  ...
	  <div class="input-group">
		<span class="input-group-addon">Meeting ID</span>
		<input id="meetingid" type="text" class="form-control" name="msg" placeholder="Meeting ID (Optional)">
	  </div>
      <div class="modal-footer">
		<button type="button" class="btn btn-primary"  onClick="javascript:shareModuleToStudents();">
          Share
        </button>
	...
	$("#myModalModules").modal("hide");
		...
		function shareModuleToStudents(){
			...
			var url = '';
			if(meetingid == null){
				url = 'shareModule?&moduleName='+moduleName+'&classifier='+classifier;
			}
			else{
				meetingid = encodeURIComponent(meetingid);
				url = 'shareModule?&moduleName='+moduleName+'&classifier='+classifier+'&meetingid='+meetingid;
			}
			...
			$.ajax({
			   ...
			   url: url,
				...
				contentType: false
				  ...
				  if(data == 'ok'){
					  notify('Success', 'Module shared by email with users');
				  }
				  else{
					  notify('Info', 'Problem in Sharing the module');
				  }
		...
		function showModulesForLicense(licname){
			licname = encodeURIComponent(licname);
				$.get("fetchModulesForAdminUserByLicense?licname="+licname, function(data, status){
				 //  console.log(data);
				//$("#moduleshowid").empty();
		...
		function showItems(encModName){
			$.get("fetchModuleDataForPreviewForAdmin?mname="+encModName, function(data, status){
				 //  console.log(data);
				$("#modalbodyid").empty();
				...
				$.ajax({
				   ...
				   url: 'uploadLMSUsers',
					...
					contentType: false
					  ...
					  if(data == 'ok'){
						  notify('Success', 'File Upload Successful. Sign off and Sign in again in case you dont find the institution - Grade - Division in the Get Users dropdown');
					  }
					  else{
						  notify('Info', 'Problem in File Upload');
					  }
				document.getElementById('idusers').value = null;	
