...
<form:input path="module.moduleName" name="moduleName" id="moduleName" required="true" disabled="${module.id == null?'false':'true'}"/>
			...
			<script>
				function addModuleItem(){
					var mname = document.getElementById('moduleName').value;
					mname = encodeURIComponent(mname);
					document.getElementById("moduleForm").action = 'moduleitem?mname='+mname;
				...
				function editModuleItem(moduleItemId){
					var mname = document.getElementById('moduleName').value;
					mname = encodeURIComponent(mname);
					document.getElementById("moduleForm").action = 'moduleitem?moduleItemId='+moduleItemId+'&mname='+mname;
					document.getElementById("moduleForm").submit();
					
				}
				
				function removeModuleItem(moduleItemId){
					document.getElementById("moduleForm").action = 'removemoduleitem?moduleItemId='+moduleItemId+'&mname='+mname;
					document.getElementById("moduleForm").submit();
