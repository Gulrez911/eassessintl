...
public class TestUtil {
	...
	@Test
	public void testEmailsendGrid(){
		EmailGenericMessageThread email = new EmailGenericMessageThread("sendgridtesting@gmail.com", "Test Email", "Test Email - Hello", propertyConfig);
		email.run();
	}
